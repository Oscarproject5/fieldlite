...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.warn('Twilio auth token decryption failed, falling back to stored value. Re-save Twilio settings to encrypt.', { tenantId: profile.tenant_id, error: decryptError instanceof Error ? decryptError.message : decryptError });
